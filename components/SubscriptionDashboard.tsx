...
const SubscriptionDashboard: FC<SubscriptionDashboardProps> = ({
  ...
  // Optimization: Memoize the O(N) category breakdown calculation to prevent redundant execution on every render (e.g., tab switching)
          ...
          {activeTab === 'overview' && (
            <div className='space-y-6'>
              ...
              <div>
                ...
                {categorySpendingData.sortedCategories.length > 0 ? (
                  <div className='grid gap-2'>
                    {categorySpendingData.sortedCategories.map(([category, amount]) => (
                        ...
                        <div className='flex items-center gap-2'>
                          <div className='w-20 md:w-24 bg-gray-200 rounded-full h-2'>
                            <div
                              ...
                              style={{
                                width: `${((amount as number) / categorySpendingData.maxCategoryAmount) * 100}%`,
                              }}
                            />
                          </div>
