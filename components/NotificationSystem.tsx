...
import { formatCurrency, formatDateNoYear } from '../utils';
    ...
    reminders.forEach(reminder => {
      if (!reminder.isRead && !reminder.isDismissed) {
        ...
        if (!existingToast) {
          ...
          addToast({
            title,
            message: `${subscription.name} - ${formatCurrency(reminder.amount)} due ${formatDateNoYear(reminder.dueDate)}`,
            type,
            duration,
          });
                        ...
                        <div className='flex items-start justify-between gap-2'>
                          <div className='flex-1'>
                            ...
                            <p className='text-sm opacity-90 mb-2'>
                              ...
                              {formatDateNoYear(reminder.dueDate)}
                            </p>
